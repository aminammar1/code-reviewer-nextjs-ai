...
export function TestVideoPlayer() {
  ...
  return (
    <div className="w-full max-w-7xl mx-auto p-6">
      {/* Modern glass container with larger size */}{' '}
      <div className="relative bg-gradient-to-br from-white/5 via-white/10 to-white/5 backdrop-blur-xl border border-white/20 rounded-3xl p-4 shadow-2xl">
        ...
        <div className="relative aspect-video rounded-2xl overflow-hidden bg-gradient-to-br from-gray-900 via-gray-800 to-black shadow-inner">
          {/* Floating particles effect - simplified to avoid hydration issues */}
